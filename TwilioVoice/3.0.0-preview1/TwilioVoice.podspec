Pod::Spec.new do |s|
  ...
  s.source       = { :http    => "https://media.twiliocdn.com/sdk/ios/voice/releases/3.0.0-preview1/twilio-voice-ios-3.0.0-preview1.tar.bz2" }
  s.documentation_url     = "https://media.twiliocdn.com/sdk/ios/voice/releases/3.0.0-preview1/docs"
