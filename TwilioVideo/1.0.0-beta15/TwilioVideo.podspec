Pod::Spec.new do |s|
  ...
  s.source       = { :http    => "https://media.twiliocdn.com/sdk/ios/video/releases/1.0.0-beta15/twilio-video-ios-1.0.0-beta15.tar.bz2" }
  s.documentation_url     = "https://media.twiliocdn.com/sdk/ios/video/releases/1.0.0-beta15/docs"
  s.libraries             = "c++"
