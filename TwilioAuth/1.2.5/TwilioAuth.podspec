Pod::Spec.new do |s|
  ...
  s.license      = {
    :type => "Commercial",
    :text => "Copyright 2011-2019 Twilio, Inc. All rights reserved. Use of this software is subject to the terms and conditions of the Twilio Terms of Service located at http://www.twilio.com/legal/tos"
  }
  s.author       = { "Twilio" => "help@twilio.com" }
  s.source       = { :http    => "https://media.twiliocdn.com/sdk/ios/auth/releases/1.2.5/twilio-auth-ios-1.2.5.tar.bz2" }
